...
public class CatalogList extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Catalog>{

    public static final String LOG_TAG = CatalogList.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getExtras() != null) {
            ...
            Log.d(LOG_TAG, "Parent: " + parent + " catCode: " + catCode);
        } else {
    ...
    public Loader<Catalog> onCreateLoader(int id, Bundle params) {
        ...
        return new CatalogLoader(this,myUrl, catCode, 1);
    }
    @Override
            ...
            public void onBindViewHolder(final CatRecyclerAdapter.MyHolder holder, final int position) {
                ...
                holder.wrap.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra(PARENT_CODE, catalog.getParentCode());
                        Log.d(LOG_TAG, "Sending parent Code: " + catalog.getParentCode());
                        intent.putExtra(CODE, catalog.getCode());
                        intent.putExtra(LEVEL, catalog.getLevel());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                Toast.makeText(this, "Got my result", Toast.LENGTH_LONG).show();
            }
        }
    }
}